...
/* opcode_action: byte -> action index. Apply each action in sequence to buf.
 * Index mapping: 0=vm_apply 1=vm_apply_inv 2=xor_buf 3=xor_inplace 4=crc32 5=adler32 6=xor_checksum
 * 7=to_hex 8=from_hex 9=read_u32be 10=write_u32be 11=read_u32le 12=write_u32le
 * 13=rotl32 14=rotr32 15=swap32 16=get_bit 17=set_bit 18=chacha_decrypt */
